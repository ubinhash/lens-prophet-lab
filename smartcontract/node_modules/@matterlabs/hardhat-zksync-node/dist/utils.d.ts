...
export declare function getAllTags(owner: string, repo: string, userAgent: string, timeout: number): Promise<any>;
export declare function resolveTag(tags: string[], latestTag: string, initialTag: string): string;
export declare function getNodeUrl(repo: string, release: string): Promise<string>;
export declare function ensureDirectory(filePath: string, options?: {
    mode: any;
}): Promise<void>;
...
export declare const startServer: (tag?: string, existingBinaryPath?: string, force?: boolean, args?: CommandArguments) => Promise<{
    commandArgs: string[];
