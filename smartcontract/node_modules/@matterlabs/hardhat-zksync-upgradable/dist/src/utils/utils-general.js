...
async function getArtifactFromBytecode(hre, bytecode) {
    ...
    throw new errors_1.ZkSyncUpgradablePluginError('Artifact for provided bytecode is not found.');
}
exports.getArtifactFromBytecode = getArtifactFromBytecode;
