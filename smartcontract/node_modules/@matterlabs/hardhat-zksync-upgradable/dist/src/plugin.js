...
async function deployBeacon(hre, taskArgs) {
    ...
    const factory = new zksync_ethers_1.ContractFactory(contract.abi, contract.bytecode, wallet);
    ...
    const proxy = await hre.upgrades.deployBeaconProxy(deployer.zkWallet, await beacon.getAddress(), contract, constructorArguments, {
