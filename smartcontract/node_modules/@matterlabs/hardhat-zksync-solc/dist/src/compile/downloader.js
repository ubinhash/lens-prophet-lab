...
class ZksolcCompilerDownloader {
    static async getDownloaderWithVersionValidated(version, configCompilerPath, compilersDir) {
        if (!ZksolcCompilerDownloader._instance) {
            ...
            if (version === 'latest') {
                console.info(chalk_1.default.yellow(constants_1.COMPILER_ZKSOLC_LATEST_DEPRECATION));
            }
            if (version !== 'latest' && version !== constants_1.ZKSOLC_COMPILER_PATH_VERSION && (0, utils_1.isVersionForDeprecation)(version)) {
                console.info(chalk_1.default.yellow((0, constants_1.COMPILER_ZKSOLC_DEPRECATION_FOR_SOLC_VERSION)(version)));
            }
    ...
    */
    static async _downloadCompilerVersionInfo(compilersDir) {
        const latestRelease = await (0, utils_1.getLatestRelease)(constants_1.ZKSOLC_BIN_OWNER, constants_1.ZKSOLC_BIN_REPOSITORY_NAME, constants_1.USER_AGENT, constants_1.fallbackLatestZkSolcVersion);
        const releaseToSave = {
