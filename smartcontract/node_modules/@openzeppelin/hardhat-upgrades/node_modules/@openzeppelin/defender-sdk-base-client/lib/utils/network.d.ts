...
export type PublicNetwork = 'alfajores' | 'amoy' | 'abstract' | 'abstract-sepolia' | 'arbitrum-nova' | 'arbitrum-sepolia' | 'arbitrum' | 'aurora' | 'auroratest' | 'avalanche' | 'base-sepolia' | 'base' | 'bsc' | 'bsctest' | 'celo' | 'fantom' | 'fantomtest' | 'fuji' | 'fuse' | 'geist-mainnet' | 'geist-polter' | 'hedera' | 'hederatest' | 'holesky' | 'japan-testnet' | 'japan' | 'linea-goerli' | 'linea-sepolia' | 'linea' | 'mainnet' | 'mantle-sepolia' | 'mantle' | 'matic-zkevm-testnet' | 'matic-zkevm' | 'matic' | 'meld-kanazawa' | 'meld' | 'moonbase' | 'moonbeam' | 'moonriver' | 'mumbai' | 'optimism-sepolia' | 'optimism' | 'peaq-mainnet' | 'peaq-agung' | 'scroll-sepolia' | 'scroll' | 'sepolia' | 'sokol' | 'unichain' | 'unichain-sepolia' | 'xdai' | 'zksync-sepolia' | 'zksync';
